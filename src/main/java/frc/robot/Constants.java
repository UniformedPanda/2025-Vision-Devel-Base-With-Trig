...
public final class Constants {
    ...
    public static final double AbsoluteSensorDiscontinuityPoint = 1.0;
    ...
    public static final class SDC {             // SDC = short for SwerveDriveConstants
        ...
        public static final double CANCODER_RANGE = AbsoluteSensorDiscontinuityPoint;
        ...
        public static final SparkMaxConfig.IdleMode STEER_MOTOR_NEUTRAL_MODE = SparkMaxConfig.IdleMode.kCoast;
    ...
    public static final class VC{
        ...
        */
        ...
        public static final double APRILTAG_HEIGHT = 27; //27 inches off the ground

        public static final double CAM_MOUNT_ANGLE = 90; //90 degrees

        //public static final double 
        public static final double CAM_HEIGHT = 13; //13 inches off the ground
